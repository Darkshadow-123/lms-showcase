...
import SocialImpactHeroTagline from "@/components/SocialImpactHeroTagline";
import MissionStatement from "@/components/MissionStatement";
import NGOImpactStats from "@/components/NGOImpactStats";
import StudentStories from "@/components/StudentStories";
import VolunteerTeachers from "@/components/VolunteerTeachers";
import RuralEducationGallery from "@/components/RuralEducationGallery";
import SocialImpactBanner from "@/components/SocialImpactBanner";
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-100">
            {trustedBy.map((school) => (
              <div key={school} className="text-lg font-heading font-bold text-secondary-500 hover:text-primary transition-colors cursor-default">
                {school}
              </div>
            ))}
          </div>
